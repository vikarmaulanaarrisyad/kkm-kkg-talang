...
export default function AsistenInggrisPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    jenisKonten: "Percakapan (Conversation)"
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("/api/generate-inggris", {
        method: "POST",
      ...
      if (!res.ok) {
        throw new Error(data.error || "Gagal menghasilkan konten Bahasa Inggris");
      }
  ...
  const copyPrompt = async () => {
    const prompt = `Anda adalah seorang ahli Bahasa Inggris dan guru untuk siswa Madrasah Ibtidaiyah (MI) / SD di Indonesia.
Buatkan ${formData.jenisKonten} dalam Bahasa Inggris dengan topik: "${formData.topik}".
...
7. Format jika Percakapan: Buat dalam tabel HTML dengan kolom: Pembicara, Kalimat Bahasa Inggris, Cara Membaca, Terjemahan.`;
  ...
  const exportWord = () => {
    ...
    <head><meta charset='utf-8'><title>Teks Bahasa Inggris</title>
    <style>
    ...
    a.href = url;
    a.download = `Bahasa_Inggris_${formData.jenisKonten}.doc`;
  ...
  return (
    <main className="grow flex flex-col w-full bg-slate-50 min-h-screen pb-20 print:bg-white print:pb-0">
      ...
      {/* Header Section */}
      <section className="w-full bg-linear-to-br from-rose-50 via-white to-pink-100/50 pt-32 pb-24 px-4 sm:px-6 relative overflow-hidden print:hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-center text-slate-800">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight mb-6">
            <span className="text-rose-600">Asisten Khusus</span> Bahasa Inggris
          </h1>
          <p className="text-lg md:text-xl text-slate-600 max-w-2xl mx-auto font-medium leading-relaxed">
            Buat percakapan, kosakata, cerita pendek, atau latihan Bahasa Inggris lengkap dengan cara baca dan terjemahan untuk siswa SD/MI.
          </p>
        </div>
      </section>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-200 sticky top-24">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  >
                    <option value="Percakapan (Conversation)">Percakapan (Conversation)</option>
                    <option value="Daftar Kosakata (Vocabulary)">Daftar Kosakata (Vocabulary)</option>
                    <option value="Cerita Pendek (Short Story)">Cerita Pendek (Short Story)</option>
                    <option value="Soal Latihan (Exercise)">Soal Latihan (Exercise)</option>
                  </select>
                </div>
                ...
                <div>
                  ...
                  <textarea 
                    name="topik"
                    placeholder="Contoh: Greetings, Animals, My Family..."
                ...
                <div>
                  ...
                  <select 
                    ...
                    className="w-full rounded-xl border border-slate-300 px-4 py-2.5 focus:border-rose-500 focus:ring-rose-500 outline-none transition-all bg-white"
                  >
                    <option value="Kelas 1-3 MI (Dasar/Beginner)">Kelas 1-3 MI (Dasar/Beginner)</option>
                    <option value="Kelas 4-6 MI (Menengah/Intermediate)">Kelas 4-6 MI (Menengah/Intermediate)</option>
                  </select>
                </div>
                ...
                <div className="flex flex-col gap-3 mt-4">
                  ...
                  >
                    ...
                    {loading ? "Menyusun Teks..." : "Generate Bahasa Inggris"}
                  </button>
                  <button 
                    type="button" 
                    onClick={copyPrompt}
          ...
          <div className="lg:col-span-2 print:col-span-1 print:w-full">
            <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200 min-h-[500px] flex flex-col print:border-none print:shadow-none print:p-0 print:m-0">
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 pb-4 border-b border-slate-100 print:hidden">
                <h2 className="text-xl font-bold text-slate-800">Hasil Teks Bahasa Inggris</h2>
              ...
              {!result && !loading && !error && (
                <div className="flex-1 flex flex-col items-center justify-center text-slate-400 py-12 print:hidden">
                  ...
                  <p className="text-center px-4 font-medium text-slate-500">
                    Pilih jenis konten dan topik yang Anda inginkan,<br/> lalu klik <strong className="text-rose-600">"Generate Bahasa Inggris"</strong>.
                  </p>
                </div>
              )}
              ...
              {loading && (
                <div className="flex-1 flex flex-col items-center justify-center text-slate-500 py-20 space-y-6 print:hidden">
                  ...
                  <p className="font-bold animate-pulse text-rose-600 text-lg">AI sedang menyusun teks bahasa Inggris...</p>
                </div>
              )}
                ...
                <div className="flex-1 overflow-y-auto max-h-[700px] pr-2 custom-scrollbar">
                 <div className="bg-white p-2 relative print:bg-white text-black" ref={resultRef}>
                  ...
                  <div className="hidden print:block text-center mb-10 pb-5 border-b-4 border-black">
                    ...
                    <p className="text-lg font-semibold text-black mt-2">Topic : {formData.topik}</p>
                  </div>
