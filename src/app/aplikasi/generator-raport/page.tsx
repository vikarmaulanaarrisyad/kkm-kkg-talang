...
5. Format hasil output dalam paragraf HTML biasa menggunakan tag <p>. Jangan gunakan judul, langsung ke isi catatan. Jangan membungkus dengan markdown \`\`\`html.`;
  ...
  return (
    <main className="grow flex flex-col w-full bg-slate-50 min-h-screen pb-20">
      ...
      {/* Header Section */}
      <section className="w-full bg-linear-to-br from-indigo-50 via-white to-purple-100/50 pt-32 pb-24 px-4 sm:px-6 relative overflow-hidden">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <textarea 
                    ...
                    rows={2}
                    className="w-full rounded-xl border border-slate-300 px-4 py-2.5 focus:border-indigo-500 focus:ring-indigo-500 outline-none transition-all bg-white resize-none"
                  ></textarea>
                </div>
